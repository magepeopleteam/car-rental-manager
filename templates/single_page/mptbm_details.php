<?php
	...
	if ( post_password_required() ) {
		...
		$post_id                   = get_the_id();
		$template_name = MPCR_Global_Function::get_post_info( $post_id, 'mptbm_theme_file', 'default.php' );
		$price_based    = MPCR_Global_Function::get_post_info( $post_id, 'mptbm_price_based' );
