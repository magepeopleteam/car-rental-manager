...
$km_or_mile = MPCR_Global_Function::get_settings('mp_global_settings', 'km_or_mile', 'km');
...
foreach ($mptbm_all_transport_id as $key => $value) {
	if (MPCR_Global_Function::get_post_info($value, 'mptbm_available_for_all_time') == 'on') {
...
$buffer_time = (int) MPCR_Global_Function::get_settings('mptbm_general_settings', 'enable_buffer_time');
	...
	<div class="<?php echo esc_attr($area_class); ?> ">
		<div class="_dLayout mptbm_search_area <?php echo esc_attr($form_style_class); ?> <?php echo esc_attr($price_based == 'manual' ? 'mAuto' : ''); ?>">
			<div class="mpForm">
				...
				<input type="hidden" id="mptbm_enable_view_search_result_page" name="mptbm_enable_view_search_result_page" value="<?php echo esc_attr( MPCR_Global_Function::get_settings( 'mptbm_general_settings', 'enable_view_search_result_page' ) ); ?>" />
				<input type='hidden' id="mptbm_enable_return_in_different_date" name="mptbm_enable_return_in_different_date" value="yes" />
				<input type="hidden" id="mptbm_enable_filter_via_features" name="mptbm_enable_filter_via_features" value="<?php echo esc_attr( MPCR_Global_Function::get_settings( 'mptbm_general_settings', 'enable_filter_via_features' ) ); ?>" />
				...
				<div class="inputList mp_input_select">
					...
					<ul class="mp_input_select_list start_time_list">
						...
						?>
							<li data-value="<?php echo esc_attr($data_value); ?>"><?php echo esc_html(MPCR_Global_Function::date_format($time_formatted, 'time')); ?></li>
						<?php } ?>
				...
				<?php
				if (MPCR_Global_Function::get_settings('mptbm_general_settings', 'enable_view_find_location_page')) {
				?>
					<a href="<?php echo esc_url( MPCR_Global_Function::get_settings( 'mptbm_general_settings', 'enable_view_find_location_page' ) ); ?>" class="mptbm_find_location_btn"><?php esc_html_e( 'Click here', 'car-rental-manager' ); ?></a>
