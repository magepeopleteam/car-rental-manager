                ...
                <div class="mpcrbm_discount_booking">
                    ...
                    <div class="mpcrbm_price_holder">
                        ...
                        <div class="mpcrbm_booking_items">
                            <?php
                            // Early Bird Discount already calculated above ($mpcrbm_discounted_price etc.)
                            ...
                            <div class="mpcrbm-price-container">
                                ...
                                // ("Save 10%") — repeating it here too ("1-day total ($1.00 saved)")
                                // was saying the same thing a third time alongside the struck-through
                                // original price.
                                ?>
