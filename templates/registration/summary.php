		...
		<div class="">
			<div class="mp_sticky_on_scroll">
				<div class="_dLayout_dFlex_fdColumn_btLight_2">
					<h3><?php esc_html_e('SUMMARY', 'wpcarrently'); ?></h3>
					<div class="dividerL"></div>

					<h6 class="_mB_xs"><?php esc_html_e('Pickup Date', 'wpcarrently'); ?></h6>
					<p class="_textLight_1"><?php echo esc_html(MP_Global_Function::date_format($date)); ?></p>
					<div class="dividerL"></div>
					<h6 class="_mB_xs"><?php esc_html_e('Pickup Time', 'wpcarrently'); ?></h6>
					<p class="_textLight_1"><?php echo esc_html(MP_Global_Function::date_format($date, 'time')); ?></p>
					<div class="dividerL"></div>
					<h6 class="_mB_xs"><?php esc_html_e('Pickup Location', 'wpcarrently'); ?></h6>
					...
					<?php if($two_way>1){ 
						...
						<?php if(!empty($return_date_time)){ ?>
                            <h6 class="_mB_xs"><?php esc_html_e('Return Date', 'wpcarrently'); ?></h6>
                            <p class="_textLight_1"><?php echo esc_html(MP_Global_Function::date_format($return_date_time)); ?></p>
                            <div class="dividerL"></div>
                            <h6 class="_mB_xs"><?php esc_html_e('Return Time', 'wpcarrently'); ?></h6>
					...
					<div class="mptbm_transport_summary">
						<div class="dividerL"></div>
						<h6 class="_mB_xs"><?php echo esc_html($label) . ' ' . esc_html__(' Details', 'wpcarrently') ?></h6>
						...
						<div class="justifyBetween">
							<h4><?php esc_html_e('Total : ', 'wpcarrently'); ?></h4>
