 ...
 */
    ...
    if (sizeof($end_locations) > 0) {
        ...
        <select class="formControl mptbm_map_end_place" id="mptbm_manual_end_place">
            <option selected disabled><?php esc_html_e(' Select Destination Location', 'wpcarrently'); ?></option>
    ...
    <?php } else { ?>
        <span class="fas fa-map-marker-alt"><?php esc_html_e(' Can not find any Destination Location', 'wpcarrently'); ?></span><?php
    }