	...
	if (!class_exists('MPTBM_Wc_Checkout_Fields')) {
		class MPTBM_Wc_Checkout_Fields {
			...
			public function checkout_menu() {
				...
				add_submenu_page('edit.php?post_type=' . $cpt, esc_html__('Checkout Fields', 'wpcarrently-car-rental-manager'), esc_html__('Checkout Fields', 'wpcarrently-car-rental-manager'), 'manage_options', 'mptbm_wc_checkout_fields', array($this, 'wc_checkout_fields'));
			}
