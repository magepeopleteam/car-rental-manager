<?php
	...
	/**
	 * Class MPCRM_Wc_Checkout_Order
	 *
	 * @since 1.0
	 *
	 * */
	if (!class_exists('MPCRM_Wc_Checkout_Order')) {
		class MPCRM_Wc_Checkout_Order {
			private $error;
							...
							<?php foreach ($contents['order'] as $key => $checkout_field) : ?>
                                ...
                                <tr>
                                    ...
                                    <td>
										...
										<?php else: ?>
											<?php MPCRM_Wc_Checkout_Fields::switch_button($key, 'checkoutSwitchButton', $key, $status, array('key' => 'order', 'name' => $key)); ?>
										<?php endif; ?>
                                    </td>
                                </tr>
							<?php endforeach; ?>
