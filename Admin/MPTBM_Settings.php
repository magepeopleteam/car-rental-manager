...
?>
		...
		public static function description_array($key)
		{
			$des = array(
				...
				'mptbm_minimum_price' => esc_html__('Sets the minimum hour. If customer selected hour is lower, the minimum will be applied', 'ecab-taxi-booking-manager'),
				...
				'mptbm_day_price' => esc_html__('Set Price per Day', 'ecab-taxi-booking-manager'),
