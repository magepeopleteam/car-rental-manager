<?php
	...
	/**
	 * Class MPCRM_Wc_Checkout_Billing
	 *
	 * @since 1.0
	 *
	 * */
	if (!class_exists('MPCRM_Wc_Checkout_Billing')) {
		class MPCRM_Wc_Checkout_Billing {
			private $error;
							...
							<?php foreach ($contents['billing'] as $key => $checkout_field) : ?>
                                ...
                                <tr>
                                    ...
                                    <td>
										...
										<?php else: ?>
											<?php MPCRM_Wc_Checkout_Fields::switch_button($key, 'checkoutSwitchButton', $key, $status, array('key' => 'billing', 'name' => $key)); ?>
										<?php endif; ?>
                                    </td>
                                </tr>
							<?php endforeach; ?>
