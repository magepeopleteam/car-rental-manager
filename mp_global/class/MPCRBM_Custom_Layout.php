<?php
	...
	if ( ! class_exists( 'MPCRBM_Custom_Layout' ) ) {
		class MPCRBM_Custom_Layout {
			public function __construct() {
				add_action( 'mpcrbm_hidden_table', array( $this, 'hidden_table' ), 10, 2 );
				add_action( 'mpcrbm_pagination_section', array( $this, 'pagination' ), 10, 3 );
			}
			...
			public static function remove_button() {
				?>
                <button class="_whiteButton_xs item_remove" type="button">
			...
			public static function move_button() {
				?>
                <div class="_mpBtn_themeButton_xs sortable_button" type="">
			...
			public static function bg_image( $post_id = '', $url = '' ) {
				$thumbnail = $post_id > 0 ? MPCRBM_Global_Function::get_image_url( $post_id ) : $url;
