	...
	if (!class_exists('MAGE_Setting_API')) {
		class MAGE_Setting_API {
			...
			function callback_text($args) {
				$value = MPCRM_Global_Function::mpcrm_get_settings($args['section'], $args['id'], $args['std']);
			...
			function callback_datepicker($args) {
				...
				$date = MPCRM_Global_Function::mpcrm_get_settings($args['section'], $args['id'], $args['std']);
			...
			function callback_pages($args) {
				$dropdown_args = array(
					'selected' => MPCRM_Global_Function::mpcrm_get_settings($args['section'], $args['id'], $args['std']),
					'name' => $args['section'] . '[' . $args['id'] . ']',
