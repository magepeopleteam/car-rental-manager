	...
	if ( ! class_exists('MPCR_Global_Style') ) {
		class MPCR_Global_Style {
			...
			public function add_inline_css_setings() {
				...
				$warning_color   = MPCR_Global_Function::get_style_settings( 'warning_color', '#E67C30' );
				$default_fs      = MPCR_Global_Function::get_style_settings( 'default_font_size', '14' ) . 'px';
				$fs_h1           = MPCR_Global_Function::get_style_settings( 'font_size_h1', '35' ) . 'px';
				$fs_h2           = MPCR_Global_Function::get_style_settings( 'font_size_h2', '30' ) . 'px';
				$fs_h3           = MPCR_Global_Function::get_style_settings( 'font_size_h3', '25' ) . 'px';
				$fs_h4           = MPCR_Global_Function::get_style_settings( 'font_size_h4', '22' ) . 'px';
				$fs_h5           = MPCR_Global_Function::get_style_settings( 'font_size_h5', '18' ) . 'px';
				$fs_h6           = MPCR_Global_Function::get_style_settings( 'font_size_h6', '16' ) . 'px';
				$fs_label        = MPCR_Global_Function::get_style_settings( 'font_size_label', '16' ) . 'px';
				$button_fs       = MPCR_Global_Function::get_style_settings( 'button_font_size', '16' ) . 'px';
				$button_color    = MPCR_Global_Function::get_style_settings( 'button_color', $alternate_color );
				$button_bg       = MPCR_Global_Function::get_style_settings( 'button_bg', '#ea8125' );
				$section_bg      = MPCR_Global_Function::get_style_settings( 'section_bg', '#FAFCFE' );
