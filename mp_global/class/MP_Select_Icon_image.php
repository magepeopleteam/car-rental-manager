			...
			public function load_icon($name, $icon = '') {
                ...
                <div class="mp_add_icon_image_area fdColumn">
                    ...
                    <div class="mp_icon_item <?php echo esc_attr($icon_class); ?>">
                        ...
                        <span class="fas fa-times mp_remove_icon mp_icon_remove" title="<?php esc_html_e('Remove Icon', 'wpcarrently-car-rental-manager'); ?>"></span>
                    </div>
                    <div class="mp_add_icon_image_button_area <?php echo esc_attr($button_active_class); ?>">
                        ...
                        <button class="_mpBtn_xs mp_icon_add" type="button" data-target-popup="#mp_add_icon_popup">
                            <span class="fas fa-plus"></span><?php esc_html_e('Icon', 'wpcarrently-car-rental-manager'); ?></button>
                        </div>
                    </div>
                </div>
				<?php
                    ...
                    <div class="mp_add_icon_popup mpPopup mpStyle" data-popup="#mp_add_icon_popup">
                        <div class="popupMainArea fullWidth">
                            <div class="popupHeader allCenter">
                                <h2 class="_mR"><?php esc_html_e('Select Icon', 'wpcarrently-car-rental-manager'); ?></h2>
                                <label class="min_300">
                                    <input type="text" class="formControl mp_name_validation" name="mp_select_icon_name" placeholder="<?php esc_attr_e('Icon/class name....', 'wpcarrently-car-rental-manager'); ?>" />
                                </label>
                                        ...
                                        <div class="dFlex">
                                            <ul class="popupIconMenu">
                                                <li class="active" data-icon-menu="all_item" data-icon-title="all_item">
													<?php esc_html_e('All Icon', 'wpcarrently-car-rental-manager'); ?>&nbsp;(
			...
			public function add_single_image($name, $image_id = '') {
                ...
                <div class="mp_add_single_image">
                    ...
                    <button type="button" class="_dButton_xs_bgColor_1_fullWidth <?php echo esc_attr($image_id ? 'dNone' : ''); ?>">
                        <span class="fas fa-images mR_xs"></span><?php esc_html_e('Image', 'wpcarrently-car-rental-manager'); ?>
                    </button>
                </div>
				<?php
			}
			...
			public function add_icon_image($name, $icon = '', $image = '') {
                ...
                <div class="mp_add_icon_image_area fdColumn">
                    ...
                    <div class="mp_image_item <?php echo esc_attr($image_class); ?>">
                        ...
                        <span class="fas fa-times mp_remove_icon mp_image_remove" title="<?php esc_html_e('Remove Image', 'wpcarrently-car-rental-manager'); ?>"></span>
                    </div>
                    <div class="mp_add_icon_image_button_area <?php echo esc_attr($button_active_class); ?>">
                        <div class="flexEqual">
                            <button class="_mpBtn_xs mp_image_add" type="button">
                                <span class="fas fa-images"></span><?php esc_html_e('Image', 'wpcarrently-car-rental-manager'); ?></button>
                            <button class="_mpBtn_xs mp_icon_add" type="button" data-target-popup="#mp_add_icon_popup">
                                <span class="fas fa-plus"></span><?php esc_html_e('Icon', 'wpcarrently-car-rental-manager'); ?></button>
                        </div>
                    </div>
