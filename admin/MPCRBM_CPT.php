	...
	if ( ! class_exists( 'MPCRBM_CPT' ) ) {
		class MPCRBM_CPT {
			...
			public function cpt(): void {
				...
				// NOTE: the mpcrbm_booking / mpcrbm_service_booking post types are
				// registered in MPCRBM_Plugin::mpcrbm_register_cpt() instead of here —
				// this class only loads in wp-admin, and the standalone Custom Payment
				// checkout has to write and read bookings on the frontend too.
