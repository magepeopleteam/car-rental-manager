                    ...
                    <div class="settings_area mpcrbm-info-cards">
                        <div class="mpcrbm-info-card">
                            <div class="mpcrbm-info-card-header">
                                ...
                                <h3><?php esc_html_e( 'Vehicle Details', 'car-rental-manager' ); ?></h3>
                            </div>
                            <div class="mpcrbm-info-card-body mpcrbm-info-grid">
								<!-- Car Type -->
								<section>
									<label class="label">
										<div>
                        ...
                        <div class="mpcrbm-info-card">
                            <div class="mpcrbm-info-card-header">
                                ...
                                <h3><?php esc_html_e( 'Capacity & Stock', 'car-rental-manager' ); ?></h3>
                            </div>
                            <div class="mpcrbm-info-card-body mpcrbm-info-grid">
                                <section>
                                    <label class="label">
